    ...
    return (
        <div>    
            ...
            <Typography onClick={handleClick}>
                Species &nbsp; {clicked ? <FontAwesomeIcon icon={faSortUp}/> : <FontAwesomeIcon icon={faSortDown}/>}
            </Typography>
                <div className={clicked ? "visible" : "hidden"} style={{display: "flex", flexDirection: "column", alignItems: "center"}}> 
            {treeArr.map((elem, i) => (
